...
const WebSocketVideoComponent = ({ onStreamReady, onStreamError }) => {
    ...
    const setupSocketConnection = () => {
        return new Promise((resolve, reject) => {
            ...
            const connectionTimeout = setTimeout(() => {
                console.error("[VideoSocket] Connection timeout");
            ...
            socketRef.current.on('connect_error', (error) => {
                clearTimeout(connectionTimeout);
                console.error("[VideoSocket] Connection error:", error);
                setConnectionStatus("Socket.IO error: " + error.message);
                reject(error);
            });

            socketRef.current.on('disconnect', () => {
                console.log("[VideoSocket] Disconnected");
    ...
    const startVideoTransmission = () => {
        ...
        const sendFrame = () => {
            if (!isTransmitting.current) { console.log("Transmission stopped"); return; }
